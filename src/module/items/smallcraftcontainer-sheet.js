export class STASmallCraftContainerSheet extends ItemSheet {
  ...
  get template() {
    ...
    if (!foundry.utils.isNewerVersion(versionInfo,"0.8.-1")) return "systems/sta2e/templates/items/smallcraftcontainer-sheet-legacy.html";
    return `systems/sta2e/templates/items/smallcraftcontainer-sheet.html`;
  }
